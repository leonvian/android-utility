...
public class FileImageDecoder {
	...
	public static final int SMALL_BITMAP = 1;
	public static final int MEDIUM_BITMAP = 2;
	public static final int LARGE_BITMAP = 3;
	...
	public static Bitmap decodeFileLarger(File file ) {
		int width = WIDTH_DEFAULT * 2;
		int heigth = HEIGHT_DEFAULT * 2;
		return decodeFile(file, width, heigth);
	}
